                                ...
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
                                    ...
                                    <div class="datatable-scroll">
                                        <table class="table datatable-basic dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="First Name: activate to sort column descending">Nombre </th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Last Name: activate to sort column ascending">Estado</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="DOB: activate to sort column ascending">Acciones</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <asp:ListView ID="CausaRet" runat="server"  DataKeyNames="Idcausaretiro" OnItemEditing="CausaRet_ItemEditing" OnItemUpdating="CausaRet_ItemUpdating" >
                                                    <ItemTemplate>
                                                        <tr role="row" class="">
                                                            <td class="sorting_1">
                                                                <asp:Label ID="NombreCausa" runat="server" Text='<%#Eval("Nombrecausaretiro")%>'></asp:Label>
                                                            </td>
                                                          
                                                            <td>
                                                                <span class='label label-success'>
                                                                    <asp:Label ID="EstadoCausa" runat="server" Text='<%#Eval("estadocausaretiro")%>'></asp:Label>
                                                                </span>
                                                            ...
                                                            <td class="text-center">
                                                                <ul class="icons-list">
                                                                    <li>
                                                                        <asp:LinkButton ID="Agregarcargo" runat="server" CommandArgument='<%#Eval("IdCausaRetiro")%>' data-popup="tooltip" title data-original-title="Editar" CommandName="Edit"> <i class="icon-pencil7" title="Agregar cargo"></i></asp:LinkButton>
                                                                    </li>
                                                    ...
                                                    <EditItemTemplate>
                                                        <tr role="row" class="">
                                                            ...
                                                            <td>
                                                                    ...
                                                                    <asp:DropDownList ID="EstadoCausa" runat="server" CssClass="form-control">
